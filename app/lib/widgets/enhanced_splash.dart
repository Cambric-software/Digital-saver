              ...
              child: Column(
                ...
                children: [
                          ...
                          builder: (context, child) {
                            return Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                boxShadow: [
                                  BoxShadow(color: const Color(0xFF2563EB).withOpacity(_glowAnimation.value), blurRadius: 50, spreadRadius: 10),
                                  BoxShadow(color: const Color(0xFF7C3AED).withOpacity(_glowAnimation.value * 0.5), blurRadius: 80, spreadRadius: 20),
                                ],
                              ),
                              child: child,
                            );
                  ...
                  AnimatedBuilder(
                    ...
                    child: Column(
                      children: [
                        const Text('Digital Saver', style: TextStyle(color: Colors.white, fontSize: 38, fontWeight: FontWeight.bold, letterSpacing: 2, shadows: [Shadow(color: Colors.black26, blurRadius: 20)])),
                        const SizedBox(height: 8),
                        ShaderMask(shaderCallback: (bounds) => const LinearGradient(colors: [Colors.white, Colors.white70, Colors.white]).createShader(bounds), child: const Text('Health Monitoring System', style: TextStyle(color: Colors.white, fontSize: 16, letterSpacing: 1))),
                      ],
                    ),
                  ),
                  ...
                  // Cambric Badge
                  AnimatedBuilder(animation: _textController, builder: (context, child) => Opacity(opacity: _textOpacity.value, child: child), child:
                    Container(
                      padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
                      decoration: BoxDecoration(color: Colors.white.withOpacity(0.15), borderRadius: BorderRadius.circular(25), border: Border.all(color: Colors.white24)),
                      child: Row(mainAxisSize: MainAxisSize.min, children: [
                        Container(width: 24, height: 24, decoration: BoxDecoration(color: Colors.white.withOpacity(0.2), borderRadius: BorderRadius.circular(6)), child: const Icon(Icons.shield, color: Colors.white, size: 14)),
                        const SizedBox(width: 8),
                        const Text('Made by Cambric', style: TextStyle(color: Colors.white70, fontSize: 13)),
                      ]),
                    ),
                  ),
