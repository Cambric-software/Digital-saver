      ...
      body: ListView(
        ...
        children: [
          ...
          if (auth.isAuthenticated) ...[
            _SyncStatusCard(userId: auth.user?.id),
            const SizedBox(height: 16),
          ],
          ...
          const SizedBox(height: 16),
          _DataManagementCard(userId: auth.user?.id),
          const SizedBox(height: 16),
          _AboutCard(),
      ...
      MaterialPageRoute(
        builder: (ctx) => AuthScreen(
          onAuthSuccess: () {
            ...
            _load(); // Reload profile after auth
          },
        ),
      ),
    );
  ...
  Future<void> _handleSignOut(BuildContext context) async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          'Are you sure you want to sign out? Your data will remain saved locally.',
