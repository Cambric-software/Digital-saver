...
class _WebLandingPageState extends State<WebLandingPage> with SingleTickerProviderStateMixin {
  ...
  // Latest version
  static const String currentVersion = 'v3.1.7';
  
  // Download URLs - Exact files from v3.1.7 release
  static const String androidUrl = 'https://github.com/Cambric-software/Digital-saver/releases/download/v3.1.7/digital_saver_android_v3.1.7.apk';
  static const String windowsUrl = 'https://github.com/Cambric-software/Digital-saver/releases/download/v3.1.7/digital_saver_windows_v3.1.7.zip';
  static const String linuxUrl = 'https://github.com/Cambric-software/Digital-saver/releases/download/v3.1.7/digital_saver_linux_v3.1.7.tar.gz';
        ...
        Wrap(
          ...
          children: [
            _DownloadButton(
              ...
              onTap: () => _downloadFile(androidUrl, 'digital_saver_android_v3.1.7.apk'),
            ),
            _DownloadButton(
              icon: Icons.window,
              label: 'Windows',
              ...
              onTap: () => _downloadFile(windowsUrl, 'digital_saver_windows_v3.1.7.zip'),
            ),
            _DownloadButton(
              icon: Icons.computer,
              label: 'Linux',
              ...
              onTap: () => _downloadFile(linuxUrl, 'digital_saver_linux_v3.1.7.tar.gz'),
            ),
            _DownloadButton(
              icon: Icons.apple,
              label: 'iOS',
