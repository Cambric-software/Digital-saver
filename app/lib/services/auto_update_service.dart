...
class AppVersion {
  ...
  static String get downloadUrl {
    if (defaultTargetPlatform == TargetPlatform.android) {
      return 'https://github.com/Cambric-software/Digital-saver/releases/download/v3.4.1/digital_saver_android_v3.4.1.apk';
    } else if (defaultTargetPlatform == TargetPlatform.windows) {
      return 'https://github.com/Cambric-software/Digital-saver/releases/download/v3.4.1/digital_saver_windows_v3.4.1.zip';
    } else if (defaultTargetPlatform == TargetPlatform.linux) {
      return 'https://github.com/Cambric-software/Digital-saver/releases/download/v3.4.1/digital_saver_linux_v3.4.1.tar.gz';
    }
